...
from gc_jira_api.Requestor import RequestExecutor, JIRA_BASE_ENDPOINT, HEADERS
...
class TestRequestExecutor(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.executor = RequestExecutor(self.jira_username, self.jira_password, self.jira_server)
    ...
    def test_fetch_data(self, mock_get):
        ...
        mock_response.json.return_value = {'values': [{'id': '1'}, {'id': '2'}], 'nextPage': None}
